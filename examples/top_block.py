...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frequency_options = (94.4e6, 89.3e6, )
        # Create the labels list
        self._frequency_labels = ('hr1', 'hr3', )
        ...
        self.top_grid_layout.addWidget(self._qtgui_waterfall_sink_x_0_win, 1, 0, 6, 3)
        for r in range(1, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.connect((self.msz_rsp1a_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
