...
class my_cw(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        labels = ['Audio Bcast', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.epy_block_0 = epy_block_0.blk(learning_vector=1000, initial_dit_length_samples=4800)
        ...
        self.connect((self.blocks_int_to_float_0, 0), (self.qtgui_time_sink_x_2, 2))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_null_sink_1, 0))
